...
def word2features(sent, i):
    """ Taking the features of a single word 
        features in use：
...
def sent2features(sent):
    """Taking features of a sequence of features"""
...
# FOR BiLSTM-CRF helper functions 


def cal_lstm_crf_loss(crf_scores, targets, tag2id):
    """calculate bilstm-crf loss 
        reference to :https://arxiv.org/pdf/1603.01360.pdf
    """
